           ...
           <div class="page-header px-5 py-1">
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <?php
                        ...
                        $query = mysqli_query($db, "SELECT protocolo.* FROM `protocolo` INNER JOIN `encaminhamento` ON protocolo.id = encaminhamento.protocolo_id WHERE encaminhamento.remetente_id = $mySetor;");
                        ...
                        while($row = mysqli_fetch_assoc($query)) {
                            ...
                            if($status == "Criado" || $status == "Encaminhado" ) {
